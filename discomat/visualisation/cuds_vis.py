...
def gvis3(
    ...
    """
    Always split (clone) Literal objects (labels/values), so same literals won't be shared.
    ...
    **** How to use it: ****
    ...
    for s, p, o in graph:
        ...
        split_obj = isinstance(o, Literal) or (p in split_object_nodes_on_predicates)
